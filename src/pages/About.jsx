    ...
    <div className="bg-gray-50 pb-20">
      ...
      <div className="relative bg-secondary text-white py-20">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">About Lotus Packers and Decker</h1>
        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              Lotus Packers and Decker is a premier logistics and relocation company dedicated to providing seamless moving experiences. With our headquarters in Noida, we have expanded our robust network to cover every corner of India.
            </p>
