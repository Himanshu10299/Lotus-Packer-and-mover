          ...
          <div className="md:w-1/3">
            <div className="bg-gray-50 border-t-4 border-primary rounded-lg p-8 shadow-lg">
              ...
              <div className="flex flex-col gap-4">
                <a href="tel:7983386937" className="bg-white border-2 border-primary text-primary px-6 py-3 rounded text-center font-bold hover:bg-primary hover:text-white transition">
                  Call +91 79833 86937
                </a>
                <Link to="/contact" className="bg-secondary text-white px-6 py-3 rounded text-center font-bold hover:bg-gray-800 transition">
                  Request Free Quote
                </Link>
              </div>
            </div>
